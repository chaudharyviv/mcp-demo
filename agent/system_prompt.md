...
2. Provide concise, clear answers in **4 to 6 lines**, bolding the single most important number or finding.
3. Note that storage data comes from the demo environment (synthetic data).
